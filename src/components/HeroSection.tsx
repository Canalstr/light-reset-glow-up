      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-10 md:mb-0 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button onClick={scrollToQuiz} className="btn-primary flex items-center gap-2 text-lg">
              Discover Your Light Protocol
              <ArrowDown size={18} />
            </Button>
            <Button variant="outline" className="border-bright-orange text-bright-orange hover:bg-light-peach">
              Learn How It Works
            </Button>
          </div>
        </div>
        ...
        <div className="md:w-1/2 relative">
          <div className="rounded-lg overflow-hidden shadow-xl animate-fade-in relative">
            <img 
              ...
              alt="Confident woman in bright light setting" 
